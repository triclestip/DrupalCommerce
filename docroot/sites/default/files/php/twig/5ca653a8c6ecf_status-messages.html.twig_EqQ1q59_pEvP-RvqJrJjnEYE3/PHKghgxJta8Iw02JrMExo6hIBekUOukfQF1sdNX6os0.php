...
class __TwigTemplate_c12b87654a06945d33d959794d53f7ff4df343105c5aa43bda61d20f4a71cdfa extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["default" => 30, "t" => 33, "length" => 71, "first" => 78];
        $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'for', 'if'],
                ['default', 't', 'length', 'first'],
                []
            );
...
";
    ...
    {
        return new Source("", "themes/bootstrap/templates/system/status-messages.html.twig", "/home/ben/www/drupal-test/themes/bootstrap/templates/system/status-messages.html.twig");
    }
}
